import { type ComponentType, createElement, type JSX } from 'preact'
...
export default function withResizableSidebar<P extends ResizableSidebarProps>(
  WrappedComponent: ComponentType<P>,
  resizeOptions?: ResizableSidebarOptions & { collapsedWidth?: number }
) {
  return function ResizableSidebarWrapper(
    props: Omit<P, keyof ResizableSidebarProps>
  ): JSX.Element {
    ...
    return (
      <div
        style={{
          display: 'flex',
          flexDirection: isLeftPanel ? 'row-reverse' : 'row'
        }}
      >
        <div
          ref={sidebar}
